...
export default class Map extends React.Component {
    constructor() {
        ...
        this.eventHandlers = {
            ...
            zoomed() {
                ...
                var h = 0;
                t[0] = Math.min((this.parent.width / this.parent.height) * (this.parent.scale - 1), Math.max(this.parent.width * (1 - this.parent.scale), t[0]));
                t[1] = Math.min(h * (this.parent.scale - 1) + h * this.parent.scale, Math.max(this.parent.height * (1 - this.parent.scale) - h * this.parent.scale, t[1]));
                try {
                    this.parent.zoom.translate(t);
                    if (this.parent.scale === 1 && this.parent.mouseClicked) {
                        this.parent.rotateMap(d3.mouse(this.parent)[0]);
                        return;
                    }
                }
                catch (e) {
    ...
    componentDidMount() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var world = yield d3.json("countries.json");
