...
var GlobalStats_1 = require("./GlobalStats");
var DownloadsMap_1 = require("./DownloadsMap");
var SignalR = require("@microsoft/signalr");
var Home = /** @class */ (function (_super) {
    __extends(Home, _super);
    function Home(props) {
        var _this = _super.call(this, props) || this;
        _this.connection = new SignalR.HubConnectionBuilder().withUrl("/downloads-notifier").build();
        _this.state = {
            showNewDl: false
        };
        return _this;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        this.connection.on("new-download", function () {
                            _this.setState({
                                showNewDl: true
                            });
